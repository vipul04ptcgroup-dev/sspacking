...
import {
  ...
  ArrowLeft, Menu, FileText, Boxes, ReceiptText, History, ShieldUser, ClipboardList, Building2, Factory, BarChart3, NotebookPen, MapPinned, Images,
} from 'lucide-react';
...
const navSections = [
  ...
  },
  {
    title: 'Engagement',
    items: [
      { icon: Images, label: 'Homepage Banners', href: '/admin/homepage' },
