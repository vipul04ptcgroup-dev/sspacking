    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-20 bg-gradient-to-br from-stone-100 to-amber-50">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-stone-500 mt-1">Join SS Packaging today</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-stone-100 p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center"><span className="bg-white px-3 text-xs text-stone-400">or register with email</span></div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Input label="Password" id="password" type="password" placeholder="Min 6 characters" error={errors.password?.message} {...register('password')} />
          ...
          <p className="text-center text-sm text-stone-500 mt-5">
            ...
            <Link href={`/auth/login${redirect !== '/' ? `?redirect=${redirect}` : ''}`} className="text-amber-600 font-semibold hover:underline">
              Sign In
            </Link>
          </p>
        </div>
