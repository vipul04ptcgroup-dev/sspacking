...
export default function AboutPage() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="bg-gradient-to-br from-stone-900 to-amber-950 text-white py-16 sm:py-20 lg:py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-stone-300 text-base sm:text-lg lg:text-xl leading-relaxed max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5 sm:gap-8">
            {stats.map(s => (
              <div key={s.label} className="text-center">
                <div className="text-3xl sm:text-4xl lg:text-5xl font-black text-amber-600 mb-2">{s.value}</div>
      ...
      {/* Story */}
      <section className="py-14 sm:py-16 lg:py-20 bg-stone-50">
        <div className="max-w-5xl mx-auto px-4 grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div>
            <p className="text-amber-600 font-semibold text-sm uppercase tracking-widest mb-3">Our Story</p>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-stone-900 mb-4 sm:mb-5">Built on a Passion for Better Packaging</h2>
            ...
            <Link href="/contact#quote" className="inline-flex w-full sm:w-auto justify-center items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white font-bold px-6 py-3 rounded-xl transition">
              Work With Us
            </Link>
          </div>
          <div className="bg-gradient-to-br from-amber-100 to-stone-200 rounded-2xl sm:rounded-3xl aspect-square max-w-sm w-full mx-auto lg:max-w-none flex items-center justify-center">
            <div className="text-center text-amber-400/60">
              <svg className="w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 mx-auto" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-14 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-stone-900">Our Core Values</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {values.map(v => (
              <div key={v.title} className="p-5 sm:p-6 rounded-2xl border border-stone-100 hover:border-amber-200 hover:shadow-lg transition-all">
